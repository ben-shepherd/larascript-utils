...
describe("minExecTime", () => {
  ...
  describe("execution time shorter than minimum", () => {
    test("should wait for minimum execution time", async () => {
      const fastFn: MinExecTimeFn<string> = jest.fn().mockResolvedValue("result" as never) as MinExecTimeFn<string>;
  ...
  describe("execution time longer than minimum", () => {
    test("should not wait additional time", async () => {
      const slowFn: MinExecTimeFn<string> = jest.fn().mockImplementation(async () => {
  ...
  describe("error handling", () => {
    test("should propagate errors from the function", async () => {
      const errorFn: MinExecTimeFn<never> = jest.fn().mockRejectedValue(new Error("Test error") as never) as MinExecTimeFn<never>;
