...
describe("validateUuid", () => {
  describe("valid UUIDs", () => {
    test("should not throw for valid UUID v4", () => {
      expect(() => validateUuid("123e4567-e89b-42d3-a456-556642440000")).not.toThrow();
  ...
  describe("invalid UUIDs", () => {
    test("should throw error for invalid UUID formats", () => {
      ...
      expect(() => validateUuid("123e4567-e89b-12d3-a456-556642440000")).toThrow("Invalid UUID format"); // Wrong version
      expect(() => validateUuid("123e4567-e89b-42d3-c456-556642440000")).toThrow("Invalid UUID format"); // Wrong variant
      expect(() => validateUuid("123e4567e89b42d3a456556642440000")).toThrow("Invalid UUID format"); // No hyphens
    });
